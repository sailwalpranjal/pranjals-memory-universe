...
import ImageAssembleGame from "./ImageAssembleGame"; // Keep existing
...
export default function PuzzlesPage() {
  ...
  if (activeGame === 'assemble') return <div className="p-4"><button onClick={() => setActiveGame(null)} className="mb-4 flex items-center text-primary"><ArrowLeft className="w-4 h-4 mr-2"/> Back</button><ImageAssembleGame /></div>;
